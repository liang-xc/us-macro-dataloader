  ...
  let insert_auction_hist =
    ...
    @@ {|
      ...
      DO UPDATE SET
          ...
          price_per100 = EXCLUDED.price_per100,
          accrued_int_per100 = EXCLUDED.accrued_int_per100,
          accrued_int_per1000 = EXCLUDED.accrued_int_per1000,
          adj_accrued_int_per1000 = EXCLUDED.adj_accrued_int_per1000,
          adj_price = EXCLUDED.adj_price,
          allocation_pctage = EXCLUDED.allocation_pctage,
          allocation_pctage_decimals = EXCLUDED.allocation_pctage_decimals,
          announcemtd_cusip = EXCLUDED.announcemtd_cusip,
          announcemt_date = EXCLUDED.announcemt_date,
          auction_format = EXCLUDED.auction_format,
          avg_med_discnt_rate = EXCLUDED.avg_med_discnt_rate,
          avg_med_investment_rate = EXCLUDED.avg_med_investment_rate, avg_med_price = EXCLUDED.avg_med_price,
          avg_med_discnt_margin = EXCLUDED.avg_med_discnt_margin,
          avg_med_yield = EXCLUDED.avg_med_yield,
          back_dated = EXCLUDED.back_dated,
          back_dated_date = EXCLUDED.back_dated_date,
          bid_to_cover_ratio = EXCLUDED.bid_to_cover_ratio,
          callable = EXCLUDED.callable,
          call_date = EXCLUDED.call_date,
          called_date = EXCLUDED.called_date,
          cash_management_bill_cmb = EXCLUDED.cash_management_bill_cmb,
          closing_time_comp = EXCLUDED.closing_time_comp,
          closing_time_noncomp = EXCLUDED.closing_time_noncomp,
          comp_accepted = EXCLUDED.comp_accepted,
          comp_bid_decimals = EXCLUDED.comp_bid_decimals,
          comp_tendered = EXCLUDED.comp_tendered,
          comp_tenders_accepted = EXCLUDED.comp_tenders_accepted,
          corpus_cusip = EXCLUDED.corpus_cusip,
          cpi_base_reference_period = EXCLUDED.cpi_base_reference_period,
          currently_outstanding = EXCLUDED.currently_outstanding,
          dated_date = EXCLUDED.dated_date,
          direct_bidder_accepted = EXCLUDED.direct_bidder_accepted,
          direct_bidder_tendered = EXCLUDED.direct_bidder_tendered,
          est_pub_held_mat_by_type_amt = EXCLUDED.est_pub_held_mat_by_type_amt,
          fima_included = EXCLUDED.fima_included,
          fima_noncomp_accepted = EXCLUDED.fima_noncomp_accepted,
          fima_noncomp_tendered = EXCLUDED.fima_noncomp_tendered,
          first_int_period = EXCLUDED.first_int_period,
          first_int_payment_date = EXCLUDED.first_int_payment_date,
          floating_rate = EXCLUDED.floating_rate,
          frn_index_determination_date = EXCLUDED.frn_index_determination_date,
          frn_index_determination_rate = EXCLUDED.frn_index_determination_rate,
          high_discnt_rate = EXCLUDED.high_discnt_rate,
          high_investment_rate = EXCLUDED.high_investment_rate,
          high_price = EXCLUDED.high_price,
          high_discnt_margin = EXCLUDED.high_discnt_margin,
          high_yield = EXCLUDED.high_yield,
          index_ratio_on_issue_date = EXCLUDED.index_ratio_on_issue_date,
          indirect_bidder_accepted = EXCLUDED.indirect_bidder_accepted,
          indirect_bidder_tendered = EXCLUDED.indirect_bidder_tendered,
          int_payment_frequency = EXCLUDED.int_payment_frequency,
          int_rate = EXCLUDED.int_rate,
          low_discnt_rate = EXCLUDED.low_discnt_rate,
          low_investment_rate = EXCLUDED.low_investment_rate,
          low_price = EXCLUDED.low_price,
          low_discnt_margin = EXCLUDED.low_discnt_margin,
          low_yield = EXCLUDED.low_yield,
          mat_date = EXCLUDED.mat_date,
          max_comp_award = EXCLUDED.max_comp_award,
          max_noncomp_award = EXCLUDED.max_noncomp_award,
          max_single_bid = EXCLUDED.max_single_bid,
          min_bid_amt = EXCLUDED.min_bid_amt, min_strip_amt = EXCLUDED.min_strip_amt,
          min_to_issue = EXCLUDED.min_to_issue,
          multiples_to_bid = EXCLUDED.multiples_to_bid,
          multiples_to_issue = EXCLUDED.multiples_to_issue,
          nlp_exclusion_amt = EXCLUDED.nlp_exclusion_amt,
          nlp_reporting_threshold = EXCLUDED.nlp_reporting_threshold,
          noncomp_accepted = EXCLUDED.noncomp_accepted,
          noncomp_tenders_accepted = EXCLUDED.noncomp_tenders_accepted,
          offering_amt = EXCLUDED.offering_amt,
          original_cusip = EXCLUDED.original_cusip,
          original_dated_date = EXCLUDED.original_dated_date,
          original_issue_date = EXCLUDED.original_issue_date,
          original_security_term = EXCLUDED.original_security_term,
          pdf_filenm_announcemt = EXCLUDED.pdf_filenm_announcemt,
          pdf_filenm_comp_results = EXCLUDED.pdf_filenm_comp_results,
          pdf_filenm_noncomp_results = EXCLUDED.pdf_filenm_noncomp_results,
          primary_dealer_accepted = EXCLUDED.primary_dealer_accepted,
          primary_dealer_tendered = EXCLUDED.primary_dealer_tendered,
          ref_cpi_on_dated_date = EXCLUDED.ref_cpi_on_dated_date,
          ref_cpi_on_issue_date = EXCLUDED.ref_cpi_on_issue_date,
          reopening = EXCLUDED.reopening,
          security_term_day_month = EXCLUDED.security_term_day_month,
          security_term_week_year = EXCLUDED.security_term_week_year,
          series = EXCLUDED.series,
          soma_accepted = EXCLUDED.soma_accepted,
          soma_holdings = EXCLUDED.soma_holdings,
          soma_included = EXCLUDED.soma_included,
          soma_tendered = EXCLUDED.soma_tendered,
          spread = EXCLUDED.spread,
          std_int_payment_per1000 = EXCLUDED.std_int_payment_per1000,
          strippable = EXCLUDED.strippable,
          tiin_conversion_factor_per1000 = EXCLUDED.tiin_conversion_factor_per1000,
          total_accepted = EXCLUDED.total_accepted,
          total_tendered = EXCLUDED.total_tendered,
          treas_retail_accepted = EXCLUDED.treas_retail_accepted,
          treas_retail_tenders_accepted = EXCLUDED.treas_retail_tenders_accepted,
          unadj_accrued_int_per1000 = EXCLUDED.unadj_accrued_int_per1000,
          unadj_price = EXCLUDED.unadj_price,
          xml_filenm_announcemt = EXCLUDED.xml_filenm_announcemt,
          xml_filenm_comp_results = EXCLUDED.xml_filenm_comp_results,
          inflation_index_security = EXCLUDED.inflation_index_security,
          tint_cusip_1 = EXCLUDED.tint_cusip_1,
          tint_cusip_2 = EXCLUDED.tint_cusip_2
    |}
  ;;
